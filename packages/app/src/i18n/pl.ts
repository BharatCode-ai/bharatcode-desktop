...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować BharatCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja BharatCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "wsl.onboarding.step.opencode": "BharatCode",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie BharatCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie BharatCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj BharatCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj BharatCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim BharatCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "BharatCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz BharatCode.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer BharatCode wewnątrz WSL w systemie Windows.",
