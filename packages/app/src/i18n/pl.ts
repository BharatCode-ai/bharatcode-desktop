export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez BharatCode",
  ...
  "provider.connect.opencodeZen.line1":
    "BharatCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w local config",
  ...
  "dialog.server.description": "Przełącz serwer BharatCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja BharatCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu BharatCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (local config) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "BharatCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the BharatCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla BharatCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd BharatCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy BharatCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw BharatCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania BharatCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji BharatCode.",
