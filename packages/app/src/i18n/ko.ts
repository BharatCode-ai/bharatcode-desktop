...
export const dict = {
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 BharatCode 서버를 실행합니다.",
  ...
  "wsl.onboarding.checkingOpencode": "BharatCode 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 BharatCode 확인 중...",
  "wsl.onboarding.updatingOpencode": "BharatCode 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 BharatCode 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 BharatCode를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "BharatCode 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 BharatCode를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "BharatCode가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 BharatCode를 설치하세요.",
  "wsl.onboarding.installOpencode": "BharatCode 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "BharatCode에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "BharatCode에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 BharatCode를 다시 여세요.",
  ...
  "desktop.wsl.error.installOpencode": "BharatCode 설치 실패",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}에 BharatCode가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateVersion":
    "BharatCode 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
