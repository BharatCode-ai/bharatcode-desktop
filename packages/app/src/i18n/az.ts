...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "BharatCode quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "BharatCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "BharatCode yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də BharatCode yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "BharatCode yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də BharatCode yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də BharatCode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "BharatCode-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "BharatCode {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "BharatCode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "BharatCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "BharatCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "BharatCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "BharatCode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra BharatCode-u yenidən açın.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində BharatCode serverini işlət.",
