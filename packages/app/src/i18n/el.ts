...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "BharatCode η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "BharatCode η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος BharatCode σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση BharatCode σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση BharatCode σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του BharatCode στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο BharatCode να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "BharatCode δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το BharatCode.",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή BharatCode μέσα στο WSL στο Windows.",
