...
export const dict: Record<string, string> = {
  ...
  "desktop.wsl.error.installOpencode": "BharatCode ইনস্টলেশন ব্যর্থ হয়েছে৷",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode {{distro}} এ ইনস্টল করা নেই",
  "desktop.wsl.error.updateVersion":
    "BharatCode আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "BharatCode পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} এ BharatCode চেক করা হচ্ছে...",
  "wsl.onboarding.updatingOpencode": "আপডেট করা হচ্ছে BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-এ BharatCode আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-এ BharatCode আপডেট করুন।",
  "wsl.onboarding.updateOpencode": "BharatCode আপডেট করুন",
  "wsl.onboarding.opencodeReadyIn": "BharatCode {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.opencodeReady": "BharatCode প্রস্তুত।",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-এ BharatCode ইনস্টল করুন।",
  "wsl.onboarding.installOpencode": "BharatCode ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) BharatCode একটি WSL সার্ভার যোগ করার আগে প্রয়োজন",
  "wsl.onboarding.wslUnavailable.title": "WSL অনুপলব্ধ",
  "wsl.onboarding.wslUnavailable.description": "BharatCode এই মেশিনে WSL যাচাই করতে পারেনি।",
  "wsl.onboarding.installWsl": "WSL ইনস্টল করুন",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ইনস্টল করা শেষ করতে Windows পুনরায় চালু করুন, তারপর BharatCode আবার খুলুন।",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে BharatCode সার্ভার চালান।",
