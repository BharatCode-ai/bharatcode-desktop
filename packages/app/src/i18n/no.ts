...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av BharatCode mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av BharatCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker BharatCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer BharatCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater BharatCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer BharatCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før BharatCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "BharatCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter BharatCode på nytt.",
