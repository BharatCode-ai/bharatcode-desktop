...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av BharatCode",
  ...
  "provider.connect.opencodeZen.line1":
    "BharatCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i local config",
  ...
  "dialog.server.description": "Bytt hvilken BharatCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av BharatCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til BharatCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (local config)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at BharatCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "BharatCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør BharatCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for BharatCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan BharatCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om BharatCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan BharatCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når BharatCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av BharatCode.",
