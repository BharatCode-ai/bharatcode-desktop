...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "Installationen av BharatCode misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "BharatCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar BharatCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar BharatCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera BharatCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera BharatCode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan BharatCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "BharatCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan BharatCode igen.",
  ...
  "settings.desktop.wsl.description": "Kör BharatCode-servern inuti WSL på Windows.",
