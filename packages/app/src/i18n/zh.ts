...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "BharatCode 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 BharatCode",
  "desktop.wsl.error.updateVersion":
    "BharatCode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 BharatCode...",
  "wsl.onboarding.updatingOpencode": "正在更新 BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 BharatCode...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 BharatCode。",
  "wsl.onboarding.updateOpencode": "更新 BharatCode",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 BharatCode 已就绪。",
  "wsl.onboarding.opencodeReady": "BharatCode 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 BharatCode。",
  "wsl.onboarding.installOpencode": "安装 BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 BharatCode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "BharatCode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "BharatCode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 BharatCode。",
