...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить BharatCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление BharatCode завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка BharatCode в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление BharatCode в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите BharatCode в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "BharatCode готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите BharatCode в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в BharatCode требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "BharatCode не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте BharatCode.",
