...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "BharatCode کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں BharatCode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "BharatCode کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "wsl.onboarding.checkingOpencode": "BharatCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں BharatCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "BharatCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں BharatCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں BharatCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "BharatCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "BharatCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "BharatCode تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں BharatCode انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "BharatCode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ BharatCode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "BharatCode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر BharatCode کو دوبارہ کھولیں۔",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر BharatCode سرور چلائیں۔",
