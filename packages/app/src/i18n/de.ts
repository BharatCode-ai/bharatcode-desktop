...
export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "BharatCode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "BharatCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "BharatCode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "BharatCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie BharatCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "BharatCode aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "BharatCode ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "BharatCode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie BharatCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "BharatCode installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor BharatCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "BharatCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann BharatCode erneut.",
  ...
  "desktop.wsl.error.installOpencode": "BharatCode-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das BharatCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
