...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "BharatCodeመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "BharatCode ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "BharatCodeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ BharatCode በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን BharatCode በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "BharatCode ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን BharatCode በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCodeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) BharatCode WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "BharatCode በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ BharatCode።",
  ...
  "settings.desktop.wsl.description": "የBharatCode አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
