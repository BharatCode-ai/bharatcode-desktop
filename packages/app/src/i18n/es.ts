export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por BharatCode",
  ...
  "provider.connect.opencodeZen.line1":
    "BharatCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "dialog.plugins.empty": "Plugins configurados en local config",
  ...
  "dialog.server.description": "Cambiar a qué servidor de BharatCode se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de BharatCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de BharatCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (local config)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, BharatCode no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "BharatCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor BharatCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para BharatCode",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve BharatCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si BharatCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de BharatCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia BharatCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de BharatCode.",
