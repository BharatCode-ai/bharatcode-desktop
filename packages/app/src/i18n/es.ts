...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar BharatCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de BharatCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando BharatCode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando BharatCode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza BharatCode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala BharatCode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que BharatCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "BharatCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir BharatCode.",
