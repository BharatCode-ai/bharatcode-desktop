...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i BharatCode dështoi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i BharatCode përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon BharatCode në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "BharatCode po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson BharatCode në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso BharatCode në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni BharatCode në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se BharatCode të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "BharatCode nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap BharatCode.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin BharatCode brenda WSL në Windows.",
