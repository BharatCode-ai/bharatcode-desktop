...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити BharatCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення BharatCode завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка BharatCode у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення BharatCode у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть BharatCode у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть BharatCode у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в BharatCode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "BharatCode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте BharatCode.",
