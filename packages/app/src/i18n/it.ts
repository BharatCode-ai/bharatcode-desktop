...
export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Controllo BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo BharatCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento BharatCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna BharatCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa BharatCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che BharatCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "BharatCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri BharatCode.",
  ...
  "settings.desktop.wsl.description": "Esegui il server BharatCode all'interno di WSL su Windows.",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di BharatCode non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di BharatCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
