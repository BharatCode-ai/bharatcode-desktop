...
export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama BharatCode {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas BharatCode {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite BharatCode {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite BharatCode į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad BharatCode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "BharatCode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite BharatCode.",
  ...
  "settings.desktop.wsl.description": "Paleiskite BharatCode serverį WSL viduje Windows.",
