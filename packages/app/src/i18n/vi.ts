...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được BharatCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật BharatCode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra BharatCode trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật BharatCode trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật BharatCode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt BharatCode trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi BharatCode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "BharatCode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại BharatCode.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ BharatCode bên trong WSL trên Windows.",
