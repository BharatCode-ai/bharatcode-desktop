...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do BharatCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O BharatCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do BharatCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o BharatCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o BharatCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o BharatCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o BharatCode",
  "wsl.onboarding.opencodeReadyIn": "O BharatCode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O BharatCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o BharatCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o BharatCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O BharatCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o BharatCode novamente.",
