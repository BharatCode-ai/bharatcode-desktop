...
export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Athugar BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar BharatCode í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir BharatCode í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu BharatCode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp BharatCode í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en BharatCode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "BharatCode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan BharatCode aftur.",
  ...
  "settings.desktop.wsl.description": "Keyrðu BharatCode netþjóninn inni í WSL á Windows.",
