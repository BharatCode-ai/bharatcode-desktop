export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje BharatCode",
  ...
  "provider.connect.opencodeZen.line1":
    "BharatCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u local config",
  ...
  "dialog.server.description": "Promijeni na koji se BharatCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija BharatCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku BharatCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (local config) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: BharatCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "BharatCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni BharatCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u BharatCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako BharatCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li BharatCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu BharatCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se BharatCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju BharatCode-a.",
