...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "Instalacija BharatCode-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje BharatCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera BharatCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje BharatCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj BharatCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj BharatCode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi BharatCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "BharatCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori BharatCode.",
