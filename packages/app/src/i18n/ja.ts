...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "BharatCodeのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはBharatCodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "BharatCodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "wsl.onboarding.checkingOpencode": "BharatCodeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のBharatCodeを確認中...",
  "wsl.onboarding.updatingOpencode": "BharatCodeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のBharatCodeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のBharatCodeを更新してください。",
  "wsl.onboarding.updateOpencode": "BharatCodeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のBharatCodeの準備ができました。",
  "wsl.onboarding.opencodeReady": "BharatCodeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にBharatCodeをインストールしてください。",
  "wsl.onboarding.installOpencode": "BharatCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "BharatCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、BharatCodeをもう一度開いてください。",
