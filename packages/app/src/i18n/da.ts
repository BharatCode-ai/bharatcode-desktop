export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af BharatCode",
  ...
  "provider.connect.opencodeZen.line1":
    "BharatCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i local config",
  ...
  "dialog.server.description": "Skift hvilken BharatCode-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af BharatCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til BharatCode-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (local config) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, BharatCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "BharatCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør BharatCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for BharatCode",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan BharatCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om BharatCode følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan BharatCode er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når BharatCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af BharatCode.",
