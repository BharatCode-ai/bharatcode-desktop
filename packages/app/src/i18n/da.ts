...
export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker BharatCode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer BharatCode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater BharatCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før BharatCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "BharatCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter BharatCode igen.",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af BharatCode mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af BharatCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
