...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت BharatCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث BharatCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من BharatCode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث BharatCode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث BharatCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت BharatCode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن BharatCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على BharatCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح BharatCode.",
