...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "نصب BharatCode انجام نشد",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode در {{distro}} نصب نشده است",
  "desktop.wsl.error.updateVersion":
    "به‌روزرسانی BharatCode به پایان رسید، اما {{distro}} همچنان {{installed}} را گزارش می‌کند. مورد انتظار {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "در حال بررسی BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "بررسی BharatCode در {{distro}}...",
  "wsl.onboarding.updatingOpencode": "در حال به روز رسانی BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "به روز رسانی BharatCode در {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "BharatCode را در {{distro}} به روز کنید.",
  "wsl.onboarding.updateOpencode": "BharatCode را به روز کنید",
  "wsl.onboarding.opencodeReadyIn": "BharatCode در {{distro}} آماده است.",
  "wsl.onboarding.opencodeReady": "BharatCode آماده است.",
  "wsl.onboarding.installOpencodeIn": "BharatCode را در {{distro}} نصب کنید.",
  "wsl.onboarding.installOpencode": "BharatCode را نصب کنید",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode نصب نشده است",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (زیر سیستم Windows برای Linux) قبل از اینکه BharatCode بتواند یک سرور WSL اضافه کند لازم است",
  "wsl.onboarding.wslUnavailable.title": "WSL در دسترس نیست",
  "wsl.onboarding.wslUnavailable.description": "BharatCode نتوانست WSL را در این دستگاه تأیید کند.",
  "wsl.onboarding.installWsl": "WSL را نصب کنید",
  "wsl.onboarding.windowsRestartRequired":
    "Windows را مجددا راه اندازی کنید تا نصب WSL به پایان برسد، سپس BharatCode را دوباره باز کنید.",
  ...
  "settings.desktop.wsl.description": "سرور BharatCode را در داخل WSL روی Windows اجرا کنید.",
