...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "BharatCode ინსტალაცია ვერ მოხერხდა",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "BharatCode განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "შემოწმებულია BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "შემოწმებულია BharatCode-ში {{distro}}...",
  "wsl.onboarding.updatingOpencode": "განახლება BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "BharatCode განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "განახლება BharatCode {{distro}}-ში.",
  "wsl.onboarding.updateOpencode": "განახლება BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode მზად არის {{distro}}-ში.",
  "wsl.onboarding.opencodeReady": "BharatCode მზად არის.",
  "wsl.onboarding.installOpencodeIn": "დააინსტალირეთ BharatCode {{distro}}-ში.",
  "wsl.onboarding.installOpencode": "დააინსტალირეთ BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ BharatCode შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "BharatCode ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით BharatCode.",
  ...
  "settings.desktop.wsl.description": "გაუშვით BharatCode სერვერი WSL-ში Windows-ზე.",
