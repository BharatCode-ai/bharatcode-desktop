...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "การติดตั้ง BharatCode ล้มเหลว",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ไม่ได้ติดตั้ง BharatCode ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต BharatCode เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ BharatCode ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต BharatCode ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต BharatCode ใน {{distro}}",
  "wsl.onboarding.updateOpencode": "อัปเดต BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.opencodeReady": "BharatCode พร้อมใช้งานแล้ว",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง BharatCode ใน {{distro}}",
  "wsl.onboarding.installOpencode": "ติดตั้ง BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง BharatCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ BharatCode จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "BharatCode ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด BharatCode อีกครั้ง",
