export const dict = {
  ...
  "command.category.provider": "BharatCode",
  ...
  "command.provider.connect": "Sign in to BharatCode",
  "command.server.switch": "Switch server",
  "command.settings.open": "Open settings",
  "command.account.open": "Open account",
  "command.account.reconnect": "Reconnect BharatCode account",
  ...
  "dialog.provider.empty": "BharatCode is not configured. Sign in from Account settings.",
  "dialog.provider.group.popular": "BharatCode",
  "dialog.provider.group.other": "Other",
  "dialog.provider.tag.recommended": "Recommended",
  "dialog.provider.bharatcode.note": "OAuth access to BharatCode models through the public beta proxy",
  "dialog.provider.bharatcode.tagline": "BharatCode OAuth",
  ...
  "dialog.model.unpaid.freeModels.title": "Models provided by BharatCode",
  "dialog.model.unpaid.addMore.title": "Sign in with BharatCode OAuth",

  "dialog.provider.viewAll": "Show BharatCode provider",

  "provider.connect.title": "Sign in to {{provider}}",
  "provider.connect.title.anthropicProMax": "Login with Claude Pro/Max",
  "provider.connect.selectMethod": "Select OAuth login for {{provider}}.",
  "provider.connect.method.apiKey": "OAuth token",
  ...
  "provider.connect.bharatcode.desktop.line1": "Connect BharatCode with the Desktop browser sign-in flow.",
  "provider.connect.bharatcode.desktop.line2":
    "A browser window will open. After sign-in, Desktop will use this account for BharatCode model requests.",
  "provider.connect.bharatcode.desktop.action": "Continue with BharatCode",
  "provider.connect.bharatcode.line1": "BharatCode account setup is handled by Desktop sign-in.",
  "provider.connect.bharatcode.command": "Open Account settings to sign in.",
  "provider.connect.bharatcode.line2": "If the sign-in action is unavailable, restart BharatCode Desktop and try again.",
  ...
  "provider.connect.opencodeZen.visit.link": "bharatcode.ai",
  "provider.connect.opencodeZen.visit.suffix": " to sign in.",
  ...
  "dialog.server.description": "Switch which BharatCode server this app connects to.",
  ...
  "toast.update.description": "A new version of BharatCode ({{version}}) is now available to install.",
  ...
  "status.popover.tab.account": "Account",
  "status.popover.tab.mcp": "MCP",
  "status.popover.tab.lsp": "LSP",
  "status.popover.tab.plugins": "Plugins",
  "status.popover.action.manageServers": "Manage servers",
  "status.popover.action.manageAccount": "Manage account",
  "status.popover.action.manageMarketplace": "Manage",
  "status.popover.capabilities.title": "Marketplace",
  "status.popover.capabilities.summary": "{{enabled}} enabled, {{setup}} need setup",
  ...
  "sidebar.gettingStarted.line1": "Sign in to BharatCode to use the public beta models.",
  "sidebar.gettingStarted.line2": "BharatCode routes model access through OAuth and the beta proxy.",
  ...
  "app.name.desktop": "BharatCode Desktop",
  ...
  "settings.account.state.needsSignIn.description": "Your BharatCode sign-in needs to be refreshed before model requests can run.",
  "settings.account.state.connectionIssue.title": "Connection issue",
  "settings.account.state.connectionIssue.description": "You are signed in, but Desktop could not reach BharatCode for the last connection check.",
  ...
  "settings.account.action.copySignInUrl": "Copy sign-in link",
  "settings.account.action.copied": "Copied",
  ...
  "settings.account.signInFallback.title": "Browser did not open?",
  "settings.account.signInFallback.description": "Copy this sign-in link and open it in any browser.",
  "settings.account.row.account": "Account",
  "settings.account.row.connection": "Connection",
  "settings.account.row.lastChecked": "Last checked",
  "settings.account.row.diagnostics": "Diagnostic logs",
  "settings.account.row.diagnostics.description": "Creates a support bundle with Desktop status, recent errors, and connection checks. Secrets and access tokens are not included.",
  "settings.account.row.localFiles": "Local files",
  "settings.account.value.connected": "Connected",
  "settings.account.value.connectionIssue": "Needs attention",
  "settings.account.value.notAvailable": "Not available",
  "settings.account.value.notChecked": "Not checked",
  ...
  "settings.account.toast.copyFailed.title": "Could not copy sign-in link",
  ...
  "settings.desktop.wsl.description": "Run the local BharatCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for BharatCode",
  ...
  "settings.general.row.appearance.description": "Customise how BharatCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether BharatCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how BharatCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when BharatCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of BharatCode.",
  ...
  "settings.providers.section.connected": "Connected BharatCode providers",
  "settings.providers.connected.empty": "No BharatCode OAuth session found",
  "settings.providers.connected.environmentDescription": "Connected from your environment variables",
  "settings.providers.section.popular": "BharatCode",
  "settings.providers.custom.description": "Custom providers are disabled in the BharatCode beta path.",
  ...
  "settings.marketplace.description": "Install trusted developer capabilities for BharatCode.",
  "settings.marketplace.search": "Search capabilities",
  "settings.marketplace.empty": "No capabilities found",
  "settings.marketplace.tab.browse": "Browse",
  "settings.marketplace.tab.installed": "Installed",
  "settings.marketplace.status.available": "Available",
  "settings.marketplace.status.installed": "Installed",
  "settings.marketplace.status.enabled": "Enabled",
  "settings.marketplace.status.needs_setup": "Needs setup",
  "settings.marketplace.status.unhealthy": "Unhealthy",
  "settings.marketplace.status.update_available": "Update available",
  "settings.marketplace.trust.bundled": "Bundled",
  "settings.marketplace.category.workflow": "Workflow",
  "settings.marketplace.category.code-hosting": "Code hosting",
  "settings.marketplace.category.browser": "Browser",
  "settings.marketplace.category.design": "Design",
  "settings.marketplace.category.planning": "Planning",
  "settings.marketplace.category.monitoring": "Monitoring",
  "settings.marketplace.category.database": "Database",
  "settings.marketplace.category.billing": "Billing",
  "settings.marketplace.category.docs": "Docs",
  "settings.marketplace.health.available": "Ready to install",
  "settings.marketplace.health.disabled": "Disabled",
  "settings.marketplace.health.notChecked": "No issues reported",
  "settings.marketplace.health.ok": "Healthy",
  "settings.marketplace.health.issue": "Needs attention",
  "settings.marketplace.meta": "By {{publisher}} · {{health}}",
  "settings.marketplace.detail.meta": "By {{publisher}} · {{category}} · v{{version}} · {{health}}",
  ...
  "settings.marketplace.configure.toast.title": "Configure {{capability}}",
  "settings.marketplace.configure.toast.description": "Open Status > MCP to finish account sign-in or restart the local app after changing environment variables.",
  "settings.marketplace.setup.toast.title": "Capability installed",
  "settings.marketplace.setup.toast.description": "Open Status > MCP to complete account sign-in if prompted.",
  "settings.marketplace.detail.modules": "Includes",
  "settings.marketplace.detail.permissions": "Permissions",
  "settings.marketplace.detail.requirements": "Setup",
  "settings.marketplace.module.skill": "Development workflow skills",
  "settings.marketplace.module.mcp": "{{name}} MCP server",
  "settings.marketplace.module.connector": "{{name}} connector",
  "settings.marketplace.module.prompt": "{{name}} prompt bundle",
  "settings.marketplace.module.surface": "{{name}} UI surface",
  "settings.marketplace.permission.workspace_files": "Can guide work in this workspace.",
  "settings.marketplace.permission.local_process": "Can launch a local process required by this capability.",
  "settings.marketplace.permission.browser_automation": "Can drive a browser for screenshots and UI smoke tests.",
  "settings.marketplace.permission.oauth_account": "Can access your connected account after you sign in.",
  "settings.marketplace.permission.network": "Can connect to this service over the network.",
  "settings.marketplace.permission.env_vars": "May require environment variables you provide.",
  "settings.marketplace.permission.background_process": "Can keep a helper process running while enabled.",
  "settings.marketplace.permission.billing_data": "Can inspect billing, customer, payment, and subscription context.",
  "settings.marketplace.permission.database_data": "Can inspect project schema, migrations, logs, and SQL context.",
  "settings.marketplace.permission.deployment_data": "Can inspect deployment and infrastructure context.",
  "settings.marketplace.permission.monitoring_data": "Can inspect errors, traces, releases, and issue context.",
