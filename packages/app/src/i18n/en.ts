...
export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Checking BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking BharatCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating BharatCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update BharatCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install BharatCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before BharatCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "BharatCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen BharatCode.",
