...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "ການຕິດຕັ້ງ BharatCode ລົ້ມເຫລວ",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode ບໍ່ໄດ້ຕິດຕັ້ງຢູ່ໃນ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "ການປັບປຸງ BharatCode ສໍາເລັດແລ້ວແຕ່ {{distro}} ຍັງລາຍງານ {{installed}}; ຄາດວ່າ {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "ກຳລັງກວດສອບ BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "ກຳລັງກວດສອບ BharatCode ໃນ {{distro}}...",
  "wsl.onboarding.updatingOpencode": "ກຳລັງອັບເດດ BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "ກຳລັງອັບເດດ BharatCode ໃນ {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "ອັບເດດ BharatCode ໃນ {{distro}}.",
  "wsl.onboarding.updateOpencode": "ອັບເດດ BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode ແມ່ນພ້ອມແລ້ວໃນ {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode ພ້ອມແລ້ວ.",
  "wsl.onboarding.installOpencodeIn": "ຕິດຕັ້ງ BharatCode ໃນ {{distro}}.",
  "wsl.onboarding.installOpencode": "ຕິດຕັ້ງ BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode ບໍ່ໄດ້ຕິດຕັ້ງ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ລະບົບຍ່ອຍຂອງ Windows ສໍາລັບ Linux) ກ່ອນທີ່ BharatCode ສາມາດເພີ່ມເຄື່ອງແມ່ຂ່າຍ WSL ໄດ້",
  "wsl.onboarding.wslUnavailable.title": "WSL ບໍ່ສາມາດໃຊ້ໄດ້",
  "wsl.onboarding.wslUnavailable.description": "BharatCode ບໍ່ສາມາດກວດສອບ WSL ໃນເຄື່ອງນີ້ໄດ້.",
  "wsl.onboarding.installWsl": "ຕິດຕັ້ງ WSL",
  "wsl.onboarding.windowsRestartRequired": "ຣີສະຕາດ Windows ເພື່ອສຳເລັດການຕິດຕັ້ງ WSL, ຈາກນັ້ນເປີດ BharatCode ຄືນໃໝ່.",
  ...
  "settings.desktop.wsl.description": "ແລ່ນເຊີບເວີ BharatCode ພາຍໃນ WSL ໃນ Windows.",
