...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "BharatCode دی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ BharatCode انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "BharatCode دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "wsl.onboarding.checkingOpencode": "BharatCode چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ BharatCode دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "BharatCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ BharatCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ BharatCode نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "BharatCode اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "BharatCode {{distro}} چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "BharatCode تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ BharatCode انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "BharatCode انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "BharatCode دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "BharatCode ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر BharatCode دوبارہ کھولو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر BharatCode سرور چلاؤ۔",
