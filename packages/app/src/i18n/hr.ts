...
export const dict = {
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera BharatCode u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje BharatCode u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte BharatCode u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte BharatCode u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte BharatCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što BharatCode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "BharatCode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite BharatCode.",
  ...
  "settings.desktop.wsl.description": "Pokrenite BharatCode poslužitelj unutar WSL na Windows.",
