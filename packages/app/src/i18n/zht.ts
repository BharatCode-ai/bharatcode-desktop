...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "BharatCode 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 BharatCode",
  "desktop.wsl.error.updateVersion":
    "BharatCode 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 BharatCode...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 BharatCode 已就緒。",
  "wsl.onboarding.opencodeReady": "BharatCode 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 BharatCode。",
  "wsl.onboarding.installOpencode": "安裝 BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 BharatCode",
  ...
  "wsl.onboarding.wslUnavailable.description": "BharatCode 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 BharatCode。",
