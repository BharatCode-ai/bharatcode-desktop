...
export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan BharatCodea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan BharatCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään BharatCodea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään BharatCodea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä BharatCode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna BharatCode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin BharatCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "BharatCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten BharatCode uudelleen.",
  ...
  "settings.desktop.wsl.description": "Suorita BharatCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "desktop.wsl.error.installOpencode": "BharatCoden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "BharatCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
