...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'BharatCode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'BharatCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'BharatCode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'BharatCode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'BharatCode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'BharatCode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour BharatCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour BharatCode",
  "wsl.onboarding.opencodeReadyIn": "BharatCode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez BharatCode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'BharatCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "BharatCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez BharatCode.",
