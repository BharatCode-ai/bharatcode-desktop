...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "Installatie van BharatCode is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De BharatCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "BharatCode controleren...",
  "wsl.onboarding.checkingOpencodeIn": "BharatCode controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "BharatCode bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "BharatCode bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk BharatCode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "BharatCode bijwerken",
  "wsl.onboarding.opencodeReadyIn": "BharatCode is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "BharatCode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer BharatCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer BharatCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat BharatCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "BharatCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens BharatCode opnieuw.",
  ...
  "settings.desktop.wsl.description": "Voer de BharatCode-server uit in WSL op Windows.",
