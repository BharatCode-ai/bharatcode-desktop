...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "BharatCode kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BharatCode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "BharatCode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "BharatCode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde BharatCode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "BharatCode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde BharatCode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki BharatCode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "BharatCode'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde BharatCode hazır.",
  "wsl.onboarding.opencodeReady": "BharatCode hazır.",
  "wsl.onboarding.installOpencodeIn": "BharatCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "BharatCode'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BharatCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "BharatCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "BharatCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından BharatCode'u tekrar açın.",
