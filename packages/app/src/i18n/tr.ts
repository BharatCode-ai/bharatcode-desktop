...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "BharatCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.opencodeZen.line1":
    "BharatCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "dialog.plugins.empty": "Eklentiler local config içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi BharatCode sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "BharatCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı BharatCode ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (local config) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: BharatCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "BharatCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "BharatCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "BharatCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "BharatCode'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "BharatCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "BharatCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "BharatCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "BharatCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "BharatCode'un en son sürümünü kullanıyorsunuz.",
