...
for (const item of targets) {
  ...
  await Bun.build({
    ...
    files: embeddedFileMap ? { "bharatcode-web-ui.gen.ts": embeddedFileMap } : {},
    entrypoints: ["./src/index.ts", parserWorker, workerPath, ...(embeddedFileMap ? ["bharatcode-web-ui.gen.ts"] : [])],
    define: {
