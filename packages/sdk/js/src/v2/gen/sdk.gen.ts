...
export class Account extends HeyApiClient {
  ...
  public authorize<ThrowOnError extends boolean = false>(
    parameters?: {
      bharatCodeAuthorizeRequest?: BharatCodeAuthorizeRequest
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams([parameters], [{ args: [{ key: "bharatCodeAuthorizeRequest", map: "body" }] }])
    return (options?.client ?? this.client).post<V2AccountAuthorizeResponses, V2AccountAuthorizeErrors, ThrowOnError>({
  ...
  public callback<ThrowOnError extends boolean = false>(
    parameters?: {
      bharatCodeCallbackRequest?: BharatCodeCallbackRequest
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams([parameters], [{ args: [{ key: "bharatCodeCallbackRequest", map: "body" }] }])
    return (options?.client ?? this.client).post<V2AccountCallbackResponses, V2AccountCallbackErrors, ThrowOnError>({
  ...
  public logout<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).post<V2AccountLogoutResponses, V2AccountLogoutErrors, ThrowOnError>({
      url: "/account/logout",
      ...options,
    })
  }
