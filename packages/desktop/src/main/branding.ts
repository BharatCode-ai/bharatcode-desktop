...
export function shouldRegisterProtocol(input: { packaged: boolean; channel: Channel; diagnostic: boolean }) {
  return input.packaged && input.channel !== "dev" && !input.diagnostic
}
