export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji BharatCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} BharatCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
