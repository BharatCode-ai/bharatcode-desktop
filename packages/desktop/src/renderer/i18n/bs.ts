export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju BharatCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} BharatCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
